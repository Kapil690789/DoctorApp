    ...
    <div class="container max-w-4xl mx-auto">
        ...
        <form method="POST" class="bg-white p-6 rounded-lg shadow form-section">
            ...
            <div class="mb-4">
                ...
                <textarea id="existing-concern" name="existing_concern" placeholder="Edit existing medical concerns"
            ...
            <div class="mb-4">
                ...
                <textarea id="existing-treatment" name="existing_treatment" placeholder="Edit existing treatment or advice"
